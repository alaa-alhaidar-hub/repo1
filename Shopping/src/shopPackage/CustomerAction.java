...
public class CustomerAction {
    ...
    public void aktion() throws SQLException, ClassNotFoundException, InterruptedException, RegistrationException {
        ...
        int checkRegister = IOTools.readInt (
                " gebe 1 wenn du Account hast, 0 wenn sie regestrieren müssen: " );
        ...
        while (aktion != 6) {
            ...
            aktion = IOTools.readInt ( " wähle eine Aktion : \n" );
            switch (aktion) {
                //menu zeigen
                case 0: {
                ...
                //bestellen
                case 2: {
                    int select = IOTools.readInt ( " wähle 1 um lebensmittel zu bestellen, 2 zu Getraenke" );
                    if (select == 1) {
                        sqlOrders.readDataBase ( "lebensmittel" );
    ...
    public boolean bestell(String tableName) throws SQLException, ClassNotFoundException {
        ...
        produktID = IOTools.readInt ( "wähle die Produkte bei ID, und 111 zu beenden" );
    ...
    public void removeArtikel() throws SQLException, ClassNotFoundException {
        stkToRemove = IOTools.readInt ( "Bitte geben Sie die Nummer des Produktes zu entfernen " );
    ...
    public Zahlung getZahlungArt() {
        zArtWählen ();
        try {
            zArt = IOTools.readInt ( " Bitte geben Sie die Art der Zahlung : " );
            switch (zArt) {
                case 0: {
                    return new Cash ();
                }
